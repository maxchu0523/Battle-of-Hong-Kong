  ...
  const handleScroll = () => {
    ...
    for (let i = 0; i < maps.length; i++) {
      const elemRect = document
        .getElementById(`mapTimeLine${i + 1}`)
        ?.getBoundingClientRect();
      if (
        elemRect &&
        position > elemRect.top - bodyRect.top &&
        position < elemRect.bottom - bodyRect.top
      ) {
        setMapName(maps[i]);
        break;
      }
    ...
    <>
      ...
      >
        <p style={{ textAlign: "center" }}>
          The Battle of Hong Kong (8–25 December 1941), also known as the
          Defence of Hong Kong and the Fall of Hong Kong, was one of the first
          battles of the Pacific War in World War II. On the same morning as the
          attack on Pearl Harbor, forces of the Empire of Japan attacked the
          British Crown colony of Hong Kong, without declaring war against the
          British Empire. The Hong Kong garrison consisted of British, Indian
          and Canadian units, also the Auxiliary Defence Units and Hong Kong
          Volunteer Defence Corps (HKVDC). Within a week the defenders abandoned
          the mainland and less than two weeks later, with their position on the
          island untenable, the colony surrendered.
        </p>
      </div>
      ...
      <div className="container">
        <div className="item">
          <div>
            <h1 style={{ textAlign: "left" }}>英日軍力不平衡</h1>
      ...
      >
        <div className="item-map-left">
          <div>
            <h1
              style={{ color: "white", textAlign: "left", paddingLeft: "2vw" }}
            >
              戰役 The Battle
            </h1>
          </div>
          ...
          <VerticalTimeline layout={"1-column"} animate={true}>
            ...
            >
              <h3
                ...
                style={{ color: "white" }}
              >
                Japanese occupation of Kowloon Peninsula
              </h3>
              <ul style={{ color: "white" }}>
            ...
            >
              <h3
                ...
                style={{ color: "white" }}
              >
                Japanese troops prepare to land on Hong Kong Island
              </h3>
              <ul style={{ color: "white" }}>
                <li> Japan Attack on Gin Drinker's Line </li>
                <li>
                  {" "}
                  Japanese air raids and bombardment of Hong Kong Island{" "}
                </li>
            ...
            >
              <h3
                ...
                style={{ color: "white" }}
              >
                Japanese landing on Hong Kong Island
              </h3>
              <ul style={{ color: "white" }}>
                <li>
                  {" "}
                  The British army's vision was obstructed by thick smoke{" "}
                </li>
            ...
            >
              <h3
                ...
                style={{ color: "white" }}
              >
                Japanese Army penetrated into Hong Kong Island
              </h3>
              <ul style={{ color: "white" }}>
                <li>
                  {" "}
                  Japanese advance along Kim Tuk's Horse Path and Tai Tam
                  Road{" "}
                </li>
            ...
            >
              <h3
                ...
                style={{ color: "white" }}
              >
                British counter-offensive failed and fell into division
              </h3>
              <ul style={{ color: "white" }}>
                <li>
                  {" "}
                  The British Western Brigade counterattacks Wong Nai Chung Gap
                </li>
                <li> Fall of Jardine's Mount</li>
                <li> Western Brigade Headquarters fell </li>
                <li>
                  {" "}
                  The last counter-attack of the British Western Brigade at Wong
                  Nai Chung Gap{" "}
                </li>
            ...
            >
              ...
              <ul style={{ color: "white" }}>
                ...
                <li>
                  {" "}
                  The British Army's Western Brigade Defense Lines gradually
                  disintegrated{" "}
                </li>
      ...
      <div className="container-story">
        ...
        <div className="item-story">
          ...
          The Hong Kong Chinese Regiment (HKCR) was a regiment that had started
          to be raised by the British Army shortly before the Battle of Hong
        ...
        <div className="item-story">
          ...
          "C" Force was the Canadian military contingent involved in the Battle
          of Hong Kong, in December 1941. Members of the force were the first
          Canadian soldiers to see action in World War II. The major Canadian
          units involved in the defence of Hong Kong were the Winnipeg
          Grenadiers and the Royal Rifles of Canada. In addition to this the
          Canadians provided a Brigade HQ.
        </div>
        <div className="item-story">
        ...
        <div className="item-story">
          ...
          During the afternoon the Company was cut off from the Battalion and
          completely surrounded by the enemy who were able to approach to within
          grenade throwing distance of the slight depression which the Company
          was holding. Several enemy grenades were thrown which Company
          Sergeant-Major Osborn picked up and threw back. The enemy threw a
          grenade which landed in a position where it was impossible to pick it
          up and return it in time. Shouting a warning to his comrades this
          gallant Warrant Officer threw himself on the grenade which exploded
          killing him instantly. His self-sacrifice undoubtedly saved the lives
          of many others.
        </div>
        ...
        <div className="item-story">
          ...
          To cope with the Japanese military threat on the eve of the Pacific
          War, the Hong Kong government introduced the Compulsory Service
          Ordinance in July 1939, requiring all British men between 18 and 41 to
          report for military service and, if fit, to be enrolled in the Hong
        ...
        <div className="item-story">
          ...
          Several hours before the British surrendered on Christmas day at the
          end of the Battle of Hong Kong, Japanese soldiers entered St.
          Stephen's College, which was being used as a hospital on the front
          line at the time. The following morning, after the surrender, the
          Japanese ordered that all these bodies should be cremated just outside
          the hall. Other soldiers who had died in the defence of Stanley were
          burned with those killed in the massacre, making well over 100
          altogether.
        </div>
        ...
        <div className="item-story">
          ...
          Though not a public holiday since July 1997, Remembrance Sunday is
          observed in Hong Kong, and is marked by a multi-faith memorial service
          at the Cenotaph in Central, Hong Kong. The service is organised by the
          Hong Kong ex-servicemen Association, and is attended by various
          Government officials and the representatives of various religious
          traditions such as the Anglican Church, the Roman Catholic Church, the
          Eastern Orthodox Church, the Buddhist community, the Taoist community,
          the Muslim community and the Sikh community.
        </div>
        <div className="item-story">
          <img src={Poppy}></img>
        </div>
